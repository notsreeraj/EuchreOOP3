...
namespace EuchreOOP3
{
    public partial class frmOptions : Form
    {
        ...
        private void btnUserInfo_Click(object sender, EventArgs e)
        {
            ...
            pnlHowToPlay.Visible=false;
            // get the user from the List of user 
            if (panUserInfo.Visible)
            {
                LoadUserStats(User.CurrentUser);
            }
        ...
        private void LoadUserStats(User user)
        {
            ...
            lblMatchesPlayed.Text = user.MatchesPlayed.ToString();
            lblWins.Text = user.Win.ToString();
            lblLosses.Text = user.Loss.ToString();
            lblDraw.Text = user.Draw.ToString();
        }
